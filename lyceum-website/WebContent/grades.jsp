	...
	<nav>
		<div class="nav-wrapper white">
		  ...
		  <ul class="right hide-on-med-and-down">
		    ...
		    <li class="yellow darken-2"><a href="grades.jsp" class="white-text text-darken-2"><i class="material-icons">grade</i></a></li>
...
<body>
	...
	<div class="flex-container">
		...
		<div id="mainTab" class="flexItemMainTab white">
			<h2 class="yellow-text text-darken-2">Grades</h2>
		</div>
